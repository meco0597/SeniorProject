...
void setup(){
  Wire.begin(13, 12); // initiate i2c system
  ...
  Serial.begin(115200); // initialize serial port to 9600 bps so you can see your debug messages in Arduino IDE via debug channel
